        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="<?= base_url('aset') ?>">Data aplikasi</a></li>
        ...
        <div class="card">
            ...
            <form role="form" method="POST" action="" autocomplete="off">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        <label for="falamat_app" class="col-md-2 col-form-label">Alamat Aplikasi</label>
                        <div class="col-md-6">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                        <select class="form-control <?php echo form_error('fjenis_app') ? 'is-invalid' : '' ?>" id="fjenis_app" name="fjenis_app">
                            <option hidden value="" selected>Pilih Jenis Aplikasi</option>
                            <option value="AU">Aplikasi Umum</option>
                            <option value="AK">Aplikasi Khusus</option>
                        </select>
                        </div>
                        <div class="invalid-feedback">
