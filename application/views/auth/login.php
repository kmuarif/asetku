...
<body class="hold-transition login-page">
    <div class="login-box">
        <div class="row  justify-content-center">
            ...
            <!-- <img src="<?= base_url() . 'assets/images/logo.png' ?>" alt="AdminLTE Logo" class="brand-image " style="width: 120;"> -->
        </div>
        <div class="login-logo">
            <img src="<?= base_url() . 'assets/images/logo.png' ?>" alt="AdminLTE Logo" class="brand-image " style="width: 80px;">

            <a href="index2.html">Aset<b>Ku</b></a>
        </div>
        <!-- /.login-logo -->
        <div class="card">
