            ...
            <form role="form" method="POST" action="" autocomplete="off">
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control <?= form_error('fdepartemen') ? 'is-invalid' : '' ?>" id="fdepartemen" name="fdepartemen" placeholder="Enter Departemen" value="<?= $this->input->post('fdepartemen'); ?>">
