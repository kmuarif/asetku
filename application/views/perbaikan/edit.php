                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <select class="form-control <?php echo form_error('fid_aset') ? 'is-invalid' : '' ?>" id="fid_aset" name="fid_aset">
                            <?php $ast = $this->input->post('fid_aset') ? $this->input->post('fid_aset') : $perbaikan->id_aset  ?>
                            <option hidden value="" selected>Pilih Aset</option>
                            <?php foreach ($aset as $key) : ?>
                                <option value="<?= $key->id_aset ?>" <?= $ast == $key->id_aset ? 'selected' : '' ?>><?= $key->kode_aset . ' - ' . $key->nama_aset ?></option>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="fketerangan_perbaikan" class="form-control <?= form_error('fketerangan_perbaikan') ? 'is-invalid' : '' ?>" id="fketerangan_perbaikan"><?= $perbaikan->keterangan_perbaikan ?></textarea>
                        <div class="invalid-feedback">
